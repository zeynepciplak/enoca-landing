...
Bu PR, Enoca Akademi Frontend projesi kapsamında geliştirilen bir arayüz bileşeni veya bölümün eklenmesi, düzenlenmesi ya da yapısal geliştirmesini içerir.  
Amaç, proje genelinde bileşen tabanlı, modüler ve SCSS destekli bir yapı kurmaktır.

---

## Yapılan Değişiklikler

- [ ] Yeni bileşen eklendi (örnek: Button, Input, Card, Modal, Accordion, Hero, Features)
- [ ] SCSS mimarisi veya responsive yapı güncellendi
- [ ] Görsel / UI düzenlemeleri yapıldı
- [ ] Kod yapısı sadeleştirildi
- [ ] Dökümantasyon dosyaları (README / CHANGELOG) güncellendi
...
> ![Ekran Resmi 2025-11-06 20 13 03](https://github.com/user-attachments/assets/e0ef6b42-5bce-4a2b-a10b-1913f1d390cd)
